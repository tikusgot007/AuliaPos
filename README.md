...
Mulai dari [`docs/README.md`](docs/README.md) — peta dokumen aturan bisnis (`AULIA.md`, `USER-SHIFT.md`), riwayat perubahan (`CHANGELOG.md`), dan arsip. Untuk panduan kerja bersama Claude Code, lihat [`CLAUDE.md`](CLAUDE.md). Pengujian: [`tests/README.md`](tests/README.md).
