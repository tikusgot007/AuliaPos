...
>
> File ini **tidak pernah direnumbering/dihapus** — banyak komentar di
> kode (`app/**`) mengutip nomor section-nya langsung (mis. "lihat
> Section 4.2"). Kalau butuh menelusuri balik satu kutipan Section
> spesifik, isi di bawah ini masih bisa dibaca apa adanya. Untuk aturan
> bisnis yang **berlaku sekarang**, baca `../AULIA.md` — jangan
> mengedit isi di bawah ini.
