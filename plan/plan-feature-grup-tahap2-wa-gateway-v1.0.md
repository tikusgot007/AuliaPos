...
| TASK-004 | **APPROVAL + RELEASE GATE**: Tunggu konfirmasi eksplisit user, lalu deploy/rilis perubahan Gateway ini **sebelum** AuliaPos Tahap 2 dirilis (`CON-004`). Catat bukti versi Gateway terpasang untuk checklist rilis plan AuliaPos (`TASK-008` plan AuliaPos). | CON-004                   | TASK-003 | -     | ✅        | 2026-09-26 |
